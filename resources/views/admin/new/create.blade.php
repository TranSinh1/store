            ...
            <div class="col-lg-7" style="padding-bottom:120px">
                ...
                @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="3" placeholder="Please Enter new detail" name="new_detail" ></textarea>
                    </div>
                    <div class="form-group">
                        <label>Images</label>
                    ...
                    <div class="form-group">
                        ...
                        <label class="radio-inline">
                            <input name="hot_new" value="1" type="radio">Hot
                        </label>
                        <label class="radio-inline">
                            <input name="hot_new" value="0" type="radio">Not hot
                        </label>
                    </div>
